...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto p-4 max-w-3xl">
        <div class="bg-white border-2 border-gray-300 rounded-lg shadow-lg p-6 mb-6">
            <h1 class="text-3xl font-bold mb-4 text-gray-900"><?php echo e($article->title); ?></h1>
            <div class="flex items-center mb-4 text-sm text-gray-600">
                <span>Category: <?php echo e($article->category ? $article->category->name : 'Uncategorized'); ?></span>
                <span class="mx-2">•</span>
                <span>Author: <?php echo e($article->author ? $article->author->name : 'Unknown Author'); ?></span>
                <span class="mx-2">•</span>
                <span>Status: 
        ...
        <div class="flex space-x-4">
            <a href="<?php echo e(route('admin.articles.index')); ?>" class="bg-gray-200 text-gray-700 px-3 py-1.5 rounded hover:bg-gray-300 text-sm">Back to List</a>
            <?php if(Auth::check() && (Auth::user()->hasRole('admin') || Auth::id() === $article->author_id)): ?>
                <a href="<?php echo e(route('admin.articles.edit', $article)); ?>" class="bg-blue-500 text-white px-3 py-1.5 rounded hover:bg-blue-600 text-sm">Edit</a>
            <?php endif; ?>
        </div>
    </div>
