    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-8">
            ...
            <div class="p-6 md:p-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-4 leading-tight"><?php echo e($article->title); ?></h1>
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600 mb-6">
                    <div class="flex items-center">
                        ...
                        <span><?php echo e($article->author ? $article->author->name : 'Unknown Author'); ?></span>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <span><?php echo e($article->category ? $article->category->name : 'Uncategorized'); ?></span>
                    </div>

                    <div class="flex items-center">
                        <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($article->status === 'published' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                    ...
                    <?php if($article->published_at): ?>
                        <div class="flex items-center">
                            ...
                            <span><?php echo e($article->published_at->format('M d, Y \a\t H:i')); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if(auth()->guard()->check()): ?>
                        <?php if(!auth()->user()->isSubscribedTo($article->author)): ?>
                            <form action="<?php echo e(route('esewa.initiate',$article->author_id)); ?>" method="GET" class="ml-auto">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                                    ...
                                    Subscribe to <?php echo e($article->author->name); ?>
                        ...
                        <?php else: ?>
                            ...
                            <form action="<?php echo e(route('subscriptions.unsubscribe',$article->author)); ?>" method="POST" class="ml-auto">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                                    class="flex items-center text-sm bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded-full transition-colors">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    Unsubscribe to <?php echo e($article->author->name); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <?php $__currentLoopData = $article->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative group overflow-hidden rounded-lg shadow-md">
                                    <img src="<?php echo e(asset('storage/' . $image->path)); ?>" alt="<?php echo e($article->title); ?> Image"
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <?php if(Auth::check() && (Auth::user()->hasRole('admin') || Auth::id() === $article->author_id)): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bishnulimbu/Desktop/coding/news-portal/news-portal/resources/views/article/show.blade.php ENDPATH**/ ?>