                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div>
                                <div class="flex items-center mb-4">
                                    <span class="material-symbols-outlined text-primary-400 text-2xl">News-Portal</span>
                                    <h5 class="ml-2 text-xl font-bold">for all</h5>
                                </div>
                            ...
                            <div>
                                <h6 class="font-semibold mb-4">News Categories</h6>
                                <ul class="space-y-2 text-slate-300">
                                    <li>
                                        <a href="#" class="hover:text-white transition-colors duration-200">Politics</a>
                                    </li>
                                    <li>
                                        <a href="#" class="hover:text-white transition-colors duration-200">Business</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#" class="hover:text-white transition-colors duration-200">Sports</a>
                                    </li>
                                    <li>
                                        <a href="#" class="hover:text-white transition-colors duration-200"
                                            >Entertainment</a
                ...
                </footer><?php /**PATH /home/bishnulimbu/Desktop/coding/news-portal/news-portal/resources/views/components/footer.blade.php ENDPATH**/ ?>