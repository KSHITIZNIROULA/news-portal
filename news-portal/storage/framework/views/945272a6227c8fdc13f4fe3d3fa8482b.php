                ...
                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article
                        ...
                        <?php if($article->images->isNotEmpty()): ?>
                            <img src="<?php echo e(asset('storage/' . $article->images->first()->path)); ?>" alt="<?php echo e($article->title); ?>"
                                ...
                                <div class="flex items-center space-x-2">
                                    <?php if($article->author): ?>
                                        <div
                                            ...
                                            <?php echo e(strtoupper(substr($article->author->name, 0, 1))); ?>

                                        </div>
                                        <span class="text-sm text-slate-600"><?php echo e($article->author->name); ?></span>
                                    <?php endif; ?>
                                </div>
...
<section class="mb-16">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="space-y-6">
   <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Latestarticles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                     ...
                     <img src="<?php echo e(asset('storage/' . $article->images->first()->path)); ?>"
                        ...
                        <div class="flex-1">
                            <div class="flex flex-wrap items-center gap-2 mb-2">
                                <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-xs font-medium">     <?php echo e($article->category->name); ?></span>
                                <span class="text-slate-500 text-sm ml-auto">  <?php echo e($article->published_at->diffForHumans()); ?></span>
                            </div>
                            <h4 class="text-lg font-semibold text-slate-800 mb-2 hover:text-primary-600 transition-colors duration-200">
                                <a href="<?php echo e(route('articles.show', $article->slug)); ?>">
                                <?php echo e($article->title); ?>
            ...
            <a href="#" 
               class="flex items-center justify-between p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors duration-200">
                ...
                <span class="text-primary-600 font-semibold">
                    <?php echo e($category->articles_count); ?> <?php echo e(Str::plural('article', $category->articles_count)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bishnulimbu/Desktop/coding/news-portal/news-portal/resources/views/home.blade.php ENDPATH**/ ?>