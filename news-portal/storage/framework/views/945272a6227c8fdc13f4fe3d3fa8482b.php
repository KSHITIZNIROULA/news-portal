                        ...
                        <article
                            ...
                            <?php if($article->images->isNotEmpty()): ?>
                                <img src="<?php echo e(asset('storage/' . $article->images->first()->path)); ?>"
                                    alt="<?php echo e($article->title); ?>" class="w-full h-48 object-cover" loading="lazy">
                            <?php else: ?>
                                    ...
                                    <div class="flex-1">
                                        <div class="flex flex-wrap items-center gap-2 mb-2">
                                            <span
                                                ...
                                                <?php echo e($article->category->name); ?></span>
                                            <span class="text-slate-500 text-sm ml-auto">
                                                <?php echo e($article->published_at->diffForHumans()); ?></span>
                                        </div>
                                        <h4
                            ...
                            <?php $__currentLoopData = $trendingCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="#"
                                    ...
                                    <span class="text-primary-600 font-semibold">
                                        ...
                                        <?php echo e(Str::plural('article', $category->articles_count)); ?>
