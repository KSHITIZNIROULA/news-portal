                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($totalArticles); ?></p>
                                </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($publishedArticles); ?></p>
                                </div>
                            ...
                            <p class="text-xs text-gray-500 mt-3"><?php echo e(round(($publishedArticles / $totalArticles) * 100, 1)); ?>%
                                of total</p>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($exclusiveArticles); ?></p>
                                </div>
                            ...
                            <p class="text-xs text-gray-500 mt-3"><?php echo e(round(($exclusiveArticles / $totalArticles) * 100, 1)); ?>%
                                of total</p>
                        </div>
                    </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="ml-4">
                                                            <div class="text-sm font-medium text-gray-900">
                                                                <a href="<?php echo e(route('publisher.articles.show', $article)); ?>"
                                                                    class="hover:text-blue-600 hover:underline"><?php echo e($article->title); ?></a>
                                                            </div>
                                                            <div class="text-sm text-gray-500">
                                                                <?php echo e($article->excerpt ? Str::limit($article->excerpt, 50) : Str::limit(strip_tags($article->content), 50)); ?>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($article->status === 'published' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    <?php echo e($article->published_at ? $article->published_at->format('M d, Y') : 'Not published'); ?>

                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex space-x-2">
                                                        <a href="<?php echo e(route('publisher.articles.edit', $article)); ?>"
                                                        ...
                                                        <form action="<?php echo e(route('publisher.articles.destroy', $article)); ?>"
                                                            method="POST"
