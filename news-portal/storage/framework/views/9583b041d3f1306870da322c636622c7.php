<!-- resources/views/admin/publisherCreate.blade.php -->


<?php $__env->startSection('content'); ?>
    <div class="container mx-auto p-4 max-w-lg">
        <h1 class="text-2xl font-bold mb-4 text-gray-800">Create New Publisher</h1>
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('admin.publishers.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex justify-end space-x-2">
                ...
                <button type="submit" class="bg-blue-500 text-white px-3 py-1.5 rounded hover:bg-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm">Create Publisher</button>
            </div>
        </form>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bishnulimbu/Desktop/coding/news-portal/news-portal/resources/views/admin/publisherCreate.blade.php ENDPATH**/ ?>