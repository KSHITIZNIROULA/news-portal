<?php $__env->startSection('content'); ?>
    <div class="container mx-auto p-6 max-w-6xl">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('admin.users.create')); ?>" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 text-base">Create New User</a>
        </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b hover:bg-gray-50 text-base">
                                ...
                                <td class="p-3"><?php echo e($user->roles->pluck('name')->implode(', ')); ?></td>
                                <td class="p-3"><?php echo e($user->created_at->format('M d, Y H:i')); ?></td>
                                <td class="p-3 flex space-x-3">
                                    
                                    <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="bg-blue-200 text-blue-700 px-3 py-1.5 rounded-lg text-sm hover:bg-blue-300">Edit</a>
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bishnulimbu/Desktop/coding/news-portal/news-portal/resources/views/admin/userIndex.blade.php ENDPATH**/ ?>