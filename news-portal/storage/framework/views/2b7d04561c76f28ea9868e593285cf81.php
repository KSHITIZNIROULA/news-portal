...
unset($__errorArgs, $__bag); ?>" required>
                    <option value="user" <?php echo e(old('role', $user->hasRole('user') ? 'user' : '') === 'user' ? 'selected' : ''); ?>>User</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex justify-end space-x-2">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-gray-200 text-gray-700 px-3 py-1.5 rounded hover:bg-gray-300 text-sm">Cancel</a>
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bishnulimbu/Desktop/coding/news-portal/news-portal/resources/views/admin/userEdit.blade.php ENDPATH**/ ?>