        ...
        <div class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-72 border-r border-gray-200 bg-white">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-5 py-3 text-base font-medium text-gray-700 bg-gray-100 rounded-lg group">
                    ...
                    <div class="relative" x-data="{ open: true }">
                        ...
                        <div x-show="open" x-transition @click.away="open = false" class="ml-10 mt-2 space-y-2">
                            <a href="<?php echo e(route('admin.articles.index')); ?>" class="block px-5 py-2.5 text-base text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">View All Articles</a>
                            <a href="<?php echo e(route('admin.articles.create')); ?>" class="block px-5 py-2.5 text-base text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">Create New Article</a>
                            <a href="<?php echo e(route('admin.categories.index')); ?>" class="block px-5 py-2.5 text-base text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">Manage Categories</a>
                            <a href="<?php echo e(route('admin.articles.index', ['status' => 'draft'])); ?>" class="block px-5 py-2.5 text-base text-gray-600 hover:bg-gray-50 rounded-lg transition-colors">View Drafts</a>
                        </div>
                    </div>
                    <!-- Other Links -->
                    <a href="<?php echo e(route('admin.publishers.index')); ?>" class="flex items-center px-5 py-3 text-base font-medium text-gray-600 hover:bg-gray-50 rounded-lg group">
                        <svg class="w-6 h-6 mr-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center px-5 py-3 text-base font-medium text-gray-600 hover:bg-gray-50 rounded-lg group">
                        <svg class="w-6 h-6 mr-4 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
...
</html><?php /**PATH /home/bishnulimbu/Desktop/coding/news-portal/news-portal/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>