...
@section('content')
    <div class="container mx-auto p-4 max-w-3xl">
        ...
        <div class="flex space-x-4">
            <a href="{{ route('publisher.articles.dashboard') }}" class="bg-gray-200 text-gray-700 px-3 py-1.5 rounded hover:bg-gray-300 text-sm">Back to Dashboard</a>
            <a href="{{ route('publisher.articles.edit', $article) }}" class="bg-blue-500 text-white px-3 py-1.5 rounded hover:bg-blue-600 text-sm">Edit</a>
        </div>
    </div>
@endsection