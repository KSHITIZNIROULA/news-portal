                     ...
                     <img src="{{ asset('storage/' . $article->images->first()->path) }}"
                        ...
                        <div class="flex-1">
                            <div class="flex flex-wrap items-center gap-2 mb-2">
                                <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-xs font-medium">     {{ $article->category->name }}</span>
                                <span class="text-slate-500 text-sm ml-auto">  {{ $article->published_at->diffForHumans() }}</span>
                            </div>
